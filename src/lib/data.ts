...
export const services = [
  ...
  },
  {
    ...
    description: "Build robust, scalable applications with modern technologies that grow with your business.",
    icon: Code,
  ...
  },
  {
    ...
    description: "Modernize infrastructure with secure, scalable cloud solutions and 24/7 monitoring.",
    icon: Cloud,
